...
/*
   Function: HotRiot.getUserData - Retreive the user data that was sent along with the original HotRiot processing request.
   ...
   See Also: <>
*/
HotRiot.getUserData = function(jsonResponse)
{
...
HotRiot.getRecord = function(jsonResponse, recordNumber)
{
    ...
    if( recordNumber == null || recordNumber == '' || recordNumber == 'undefined' )
        recordNumber = 1;
...
HotRiot.deleteRecord = function( recordNumber, jsonResponse, successProcessing, errorProcessing )
{
    HotRiot.clearLastProcessingErrorCode();
    if( HotRiot.isValidRecordNumber(recordNumber, jsonResponse) == true )
    {
...
HotRiot.logout = function(successProcessing, errorProcessing)
{
   HotRiot.postLink( HotRiot.fullyQualifiedHRDAURL + '?hsp-logout=hsp-json', successProcessing, errorProcessing );
   return true;
}
